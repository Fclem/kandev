...
import { StepAgentProfileSelect } from "./workflow-pipeline-editor-agent-profile-select";
    ...
    <div className="space-y-2">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        <Trans i18nKey="settings:typeInsertsTheTaskDescriptionOr">
          ...
          references it. Note: {"{{task_prompt}}"} only expands in the step prompt itself, not
          inside a referenced saved prompt.
        </Trans>
      </p>
    </div>
  );
