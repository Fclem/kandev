...
func (s *GitHubWebhookSubscriber) checkPushTrigger(
	...
	data, _ := json.Marshal(map[string]interface{}{
		...
		automationBranchKey:  payload.Branch,
		automationSHAKey:     payload.SHA,
		"pusher_login":       payload.PusherLogin,
		automationMessageKey: payload.HeadCommitMsg,
	})
...
func (s *GitHubWebhookSubscriber) checkCITrigger(
	...
	data, _ := json.Marshal(map[string]interface{}{
		...
		automationBranchKey:     payload.Branch,
		automationSHAKey:        payload.SHA,
		automationCheckNameKey:  payload.CheckName,
		automationConclusionKey: payload.Conclusion,
