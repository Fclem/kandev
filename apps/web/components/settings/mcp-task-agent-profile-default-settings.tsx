...
const OPTIONS: Array<{
  ...
  {
    value: "current_task",
    label: "settings:currentTaskProfile",
    description: "settings:theNewTaskUsesTheSame",
  },
  {
    value: "workspace_default",
    label: "settings:workspaceDefaultProfile",
    description: "settings:theNewTaskUsesItsWorkflow",
  },
];
  ...
  return (
    <CardDescription className="space-y-3">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center gap-1 text-foreground">
          ...
          <Tooltip>
            ...
            <TooltipContent side="top" className="max-w-xs text-xs">
              <Trans i18nKey="settings:createTaskKandevCreatesASeparate">
        ...
        <p>
          <Trans i18nKey="settings:createTaskKandevCreatesNewTasks">
        ...
        <p>
          <Trans i18nKey="settings:spawnSessionKandevAndTasksYou">
            <code className="rounded-sm bg-muted px-1 py-0.5 text-foreground">
    ...
    <SettingsCard isDirty={isDirty} data-testid="mcp-task-profile-default-card">
      <CardHeader>
        <CardTitle className="text-base">
          <h3>{t("settings:profileForTasksCreatedByAgents2")}</h3>
        </CardTitle>
