...
export const ISSUE_WATCH_PLACEHOLDERS: ScriptPlaceholder[] = [
  {
    key: "issue.link",
    descriptionKey: "github:issueUrl",
    example: "https://github.com/org/repo/issues/42",
    executor_types: [],
  },
  {
    key: "issue.number",
    descriptionKey: "github:issueNumber",
    example: "42",
    executor_types: [],
  },
  {
    key: "issue.title",
    descriptionKey: "github:issueTitle",
    example: "Fix login page crash",
    executor_types: [],
  },
  {
    key: "issue.author",
    descriptionKey: "github:issueAuthorUsername",
    example: "octocat",
    executor_types: [],
  },
  {
  ...
  {
    key: "issue.labels",
    descriptionKey: "github:commaSeparatedLabels",
    example: "bug, priority:high",
    executor_types: [],
  },
  {
    key: "issue.body",
    descriptionKey: "github:issueBodyText",
